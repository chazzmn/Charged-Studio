...
| Create GitHub repo: `charged-website` | Charlie | ⬜ |
| Connect Vercel to GitHub repo | Charlie | ⬜ |
...
| Build `<Nav />` component | Claude | ⬜ |
| Build `<Footer />` component | Claude | ⬜ |
...
| Case study: Devon Nurseries (`/devon-nurseries`) | ⬜ |
| Case study: CHAZZMN (`/chazzmn`) | ⬜ |
| Case study: The Unaffiliated (`/the-unaffiliated`) | ⬜ |
...
| Contact form — connected to Resend / email delivery tested | ⬜ |
